    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(decimal_places=16, max_digits=27, null=True)),
                ('longitude', models.DecimalField(decimal_places=16, max_digits=27, null=True)),
                ...
                ('collection_status', models.CharField(choices=[('Pending', 'Pending'), ('Cancel', 'Cancel'), ('Done', 'Done')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_quantity', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('received_net_val', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
